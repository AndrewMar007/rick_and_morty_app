...
Future<void> init() async {
  ...
  sl.registerLazySingleton<EpisodeViewModel>(() => EpisodeViewModelImpl(networkInfo: sl(), service: sl()));
  sl.registerLazySingleton<EpisodeService>(() => EpisodeServiceImpl(client: sl()));
